import '../message_default_screen/widgets/listellipseseventeen1_item_widget.dart';
...
class MessageDefaultScreen extends GetWidget<MessageDefaultController> {
  @override
            ...
            appBar: CustomAppBar(
                ...
                actions: [
                  ...
                  AppbarImage(
                      ...
                      margin:
                          getMargin(left: 16, top: 22, right: 17, bottom: 22))
                ],
                ...
                child: SingleChildScrollView(
                    child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              Container(
                                  height: getVerticalSize(1056.00),
                                                                    ...
                                                                    child: Row(
                                                                        children: [
                                                                          Container(
                                                                              ...
                                                                              decoration: AppDecoration.txtFillDeeppurpleA10001.copyWith(borderRadius: BorderRadiusStyle.txtCircleBorder12),
                                                                              child: Text("lbl_tg".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.txtMuktaSemiBold13.copyWith(height: getVerticalSize(0.74)))),
                                                                          Padding(
                                                                          ...
                                                                          Container(
                                                                              ...
                                                                              decoration: AppDecoration.txtFillLightblue600.copyWith(borderRadius: BorderRadiusStyle.txtCircleBorder12),
                                                                              child: Text("lbl_jd".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AppStyle.txtMuktaSemiBold13.copyWith(height: getVerticalSize(0.74)))),
                                                                          Padding(
                                                                              padding: getPadding(left: 6, top: 3, bottom: 3),
                                                ...
                                                child: Obx(() =>
                                                    ListView.separated(
                                                        ...
                                                        itemCount: controller
                                                            .messageDefaultModelObj
                                                            .value
                                                            .listellipseseventeen1ItemList
                                                            .length,
                                                        itemBuilder:
                                                            (context, index) {
                                                          Listellipseseventeen1ItemModel
                                                              model = controller
                                                                  .messageDefaultModelObj
                                                                  .value
