...
class OrderTrackingShowerStopScreen
    extends GetWidget<OrderTrackingShowerStopController> {
  @override
                                                                        ...
                                                                        child: Stack(alignment: Alignment.topLeft, children: [
                                                                          Align(
                                                                              ...
                                                                              child: Container(
                                                                                  ...
                                                                                  margin: getMargin(top: 23, right: 36),
                                                                                  decoration: AppDecoration.outlineTeal9004c,
                                                                                  child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                    CustomImageView(svgPath: ImageConstant.imgContrastWhiteA700, height: getVerticalSize(10.00), width: getHorizontalSize(13.00)),
                                                                                    Container(
                                                                                        width: getHorizontalSize(204.00),
                                                                                        ...
                                                                                        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                          Padding(
                                                                                              ...
                                                                                              child: Row(children: [
                                                                                                CustomImageView(svgPath: ImageConstant.imgVolumeYellow900, height: getSize(16.00), width: getSize(16.00), margin: getMargin(top: 3, bottom: 4)),
                                                                                                Padding(padding: getPadding(left: 4), child: Text("lbl_shower_stop".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtMuktaRegular14Bluegray900.copyWith(height: getVerticalSize(0.69))))
                                                                                              ])),
                                                                                          Text("msg_27_zursur_court".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtMuktaRegular14Bluegray900.copyWith(height: getVerticalSize(0.77))),
                                                                                          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                                            Padding(padding: getPadding(top: 1), child: Text("lbl_11_45_pm".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtMuktaRegular12.copyWith(height: getVerticalSize(0.70)))),
                                                                                            Container(height: getSize(2.00), width: getSize(2.00), margin: getMargin(left: 6, top: 9, bottom: 10), decoration: BoxDecoration(color: ColorConstant.blueGray300, borderRadius: BorderRadius.circular(getHorizontalSize(1.00)))),
                                                                                            Padding(padding: getPadding(left: 6, bottom: 1), child: Text("lbl_20_min".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtMuktaRegular12.copyWith(height: getVerticalSize(0.70)))),
                                                                                            Container(height: getSize(2.00), width: getSize(2.00), margin: getMargin(left: 6, top: 9, bottom: 10), decoration: BoxDecoration(color: ColorConstant.blueGray300, borderRadius: BorderRadius.circular(getHorizontalSize(1.00)))),
                                                                                            Padding(padding: getPadding(left: 6, top: 1), child: Text("lbl_today".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtMuktaRegular12.copyWith(height: getVerticalSize(0.70))))
                                                                                          ])
                                                                                        ]))
                                                                                  ]))),
                                                                          Align(
                                                                          ...
                                                                          Align(
                                                                              alignment: Alignment.topRight,
                                                                              child: Container(height: getSize(10.00), width: getSize(10.00), margin: getMargin(right: 133), decoration: BoxDecoration(color: ColorConstant.whiteA700, borderRadius: BorderRadius.circular(getHorizontalSize(5.00)), border: Border.all(color: ColorConstant.indigo70066, width: getHorizontalSize(6.00), strokeAlign: StrokeAlign.outside)))),
                                                                          Align(
